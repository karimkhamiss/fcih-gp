...
testsList.append(Test(["Liver Diseases"],"SGOT(AST)","digit",[(0,100),(10,40)],[(0,100),(10,40)],"لا يقل","الصفرا و أمراض الكبد ويسبب اصفرار لون العين - التهاب الكبد A,B,C - وجود فيروسات"))
testsList.append(Test(["Liver Diseases"],"SGPT(AlT)","digit",[(0,100),(10,40)],[(0,100),(10,40)],"لا يقل","الصفرا و أمراض الكبد ويسبب اصفرار لون العين - التهاب الكبد A,B,C - وجود فيروسات"))
