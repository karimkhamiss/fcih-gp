...
#      pickle.dump(test, open("bin\\"+cat.lower()+".bin", "wb"))
#
# for test in testsList:
#     for cat in test.category:
#       pickle.dump(test, open("bin\\"+cat.lower()+".bin", "ab"))
...
def match(lineList):
    ...
    with (open("bin\\"+lineList[0] + ".bin", "rb")) as openfile:  # file name will be determined by category name from the test
        while True:
            try:
